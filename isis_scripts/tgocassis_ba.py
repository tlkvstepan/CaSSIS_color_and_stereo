...
parser = argparse.ArgumentParser(
    description='Function performs bundle adjustment')
...
# create network
# (for some reason there are problems with autoseed)
...
exe_str = 'jigsaw fromlist="%s" sigma0=1e-3 model1=huber maxits=200 radius=yes point_radius_sigma=200 camera_angles_sigma=0.007 cnet="%s" onet="%s" observations=Yes update=True' % (
    nonempty_cubes_list_fn, valid_net_fn, ba_net_fn)
